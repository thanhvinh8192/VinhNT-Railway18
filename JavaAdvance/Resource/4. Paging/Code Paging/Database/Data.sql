...
VALUES                  (N'Marketing'	,	5		,	'2020-03-05'),
                        ...
                        (N'Bán hàng1'	,	5		,	'2020-04-09');

-- Add data Account
INSERT INTO `Account`(Email								, Username			, FirstName,	LastName,		 DepartmentID	,	CreateDate)
VALUES 				('haidang29productions@gmail.com'	, 'dangblack'		,'Dang'	,		'Nguyen Hai'	,   '1'			,	'2020-03-05'),
                    ...
                    ('dapphatchetngay@gmail.com'		, 'khabanh'			,'Kha'	,		'Ngo Ba'		,   '1'			,	NOW()),
